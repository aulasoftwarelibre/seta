...
class PenaltyListenerSpec extends ObjectBehavior
{
    ...
    public function its_subscribed_to_penalty_created_event()
    {
    ...
    public function its_subscribed_to_penalty_closed_event()
    {
        $this->getSubscribedEvents()
    ...
    public function it_sets_penalized_flag(
        ObjectManager $manager,
        PenaltyEvent $event,
        User $user
    ) {
    ...
    public function it_unsets_penalized_flag(
    ...
    public function it_checks_if_have_pending_penalties(
        ArrayCollection $collection,
        ArrayCollection $empty,
        ObjectManager $manager,
        PenaltyEvent $event,
