...
class User extends BaseUser
{
     ...
     * @return User
     */
    public function addPenalty(\App\Entity\Penalty $penalty)
    {
     ...
     * @return User
     */
    public function removePenalty(\App\Entity\Penalty $penalty)
    {
     ...
     * Set faculty.
     *
     * @param \App\Entity\Faculty $faculty
     *
     * @return User
     */
    public function setFaculty(\App\Entity\Faculty $faculty = null)
    {
